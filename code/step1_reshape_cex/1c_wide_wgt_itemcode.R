...
for (target_year in years_to_process) {
  ...
  # Using our calculated yearquarter_calc to match the crosswalk's yearquarter
  ...
  # We exclude the temporary calculation columns and the original ucc/cost columns
  ...
  # Optional: clear memory for the next year in the loop
